...
function filtrerNombresValides(tableau) {
    return tableau.filter(valeur => typeof valeur === 'number' && Number.isFinite(valeur));
}
const donneesScrapees = ["Prix", 15.5, null, "Quantite", 3, undefined, "Total", 46.5, NaN];
const resultat = filtrerNombresValides(donneesScrapees);
